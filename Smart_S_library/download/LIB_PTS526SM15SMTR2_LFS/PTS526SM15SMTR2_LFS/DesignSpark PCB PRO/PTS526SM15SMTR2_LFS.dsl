...
(library Library_1
	...
	(patternDef "PTS526SM15SMTR2LFS" (originalName "PTS526SM15SMTR2LFS")
		...
		(layerContents (layerNumRef 28)
			(line (pt 0 2.6) (pt -1.8 2.6) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.8 2.6) (pt -2.6 1.2) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.6 1.2) (pt -2.6 -1.2) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.6 -1.2) (pt -1.8 -2.6) (width 0.1))
		)
		(layerContents (layerNumRef 28)
		...
		(layerContents (layerNumRef 28)
			(line (pt 1.8 2.6) (pt 0 2.6) (width 0.1))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "PTS526SM15SMTR2_LFS" (originalName "PTS526SM15SMTR2_LFS") (compHeader (numPins 4) (numParts 1) (refDesPrefix S)
		...
		(compPin "1" (pinName "COM 1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "COM 2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "NO 1") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "NO 2") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.ckswitches.com/media/2780/pts526.pdf")
		(attr "Height" "1.65 mm")
	)
